...
void placeOrder(item* itemToBuy) {
	...
	if (itemQuantity > itemToBuy->availableQuantity)
		...
		MyFile << "Customer name : " << userName << endl
			<< "Customer password : " << userPassword << endl
			<< "Customer Address : " << customerAddress << endl
			<< "Item name : " << itemToBuy->itemName << endl
			<< "Item Quantity : " << itemQuantity << endl
			<< "Item Price : " << totalPrice << endl
			<< "Source vertex : " << src << endl
			<< "Destination vertex : " << dest << endl
			<< "Distnce from src-dest : " << wt << endl;
		cout << "-----------------------------------" << endl;
